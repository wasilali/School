...
<div className="hallo relative flex flex-col justify-center items-center mt-12 h-[90vh]">
      ...
      <div className="container mx-auto md:px-12 px-4 py-16 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className=" bg-hero-pattern bg-cover bg-no-repeat bg-center z-10 h-[60vh] service-card bg-white rounded-md shadow-md p-6 flex flex-col items-center">
          ...
          <div className=" bg-hero-pattern bg-cover bg-no-repeat bg-center h-[60vh] z-10 service-card bg-white rounded-md shadow-md p-6 flex flex-col items-center">
